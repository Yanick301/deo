    ...
    <div className="overflow-x-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
           <div className="relative group h-[800px] overflow-hidden">
              ...
              <div className="absolute inset-0 bg-black/20 group-hover:bg-black/40 transition-colors flex flex-col items-center justify-center text-white p-12 text-center">
                ...
                <Link to="/category/men-clothing" className="border-b border-white pb-1 hover:text-brand-gold hover:border-brand-gold transition-colors">
                  {t('cta_discover_more')}
                </Link>
              </div>
           </div>
           <div className="relative group h-[800px] overflow-hidden">
              ...
              />
               <div className="absolute inset-0 bg-black/20 group-hover:bg-black/40 transition-colors flex flex-col items-center justify-center text-white p-12 text-center">
                ...
                <Link to="/category/women-clothing" className="border-b border-white pb-1 hover:text-brand-gold hover:border-brand-gold transition-colors">
                  {t('cta_discover_more')}
                </Link>
              </div>
           </div>
      ...
      <section className="py-32 container mx-auto px-6">
        <div className="flex justify-between items-end mb-16">
          ...
          <Link to="/category/brand-collections" className="hidden md:block uppercase tracking-widest text-xs border-b border-black pb-1 hover:text-brand-gold hover:border-brand-gold transition-colors">
            {t('view_all')}
          </Link>
        </div>
        ...
        <div className="text-center mt-12 md:hidden">
           <Link to="/category/brand-collections" className="uppercase tracking-widest text-xs border-b border-black pb-1">
            {t('view_all')}
          </Link>
        </div>
      </section>
